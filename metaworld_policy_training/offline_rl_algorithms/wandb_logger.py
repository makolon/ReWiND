...
from stable_baselines3.common.logger import DEBUG, INFO, WARN, ERROR, DISABLED
...
class WandBLogger:
    ...
    def __init__(self, folder: Optional[str]= None, output_formats = None):
    ...
    def record_dict(self, metrics_dict: dict):
        self.name_to_value.update(metrics_dict)
